    ...
    <main className="grid grid-cols-2 min-h-screen">
      <div className="flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
        ...
        <div className='space-y-5'>
          ...
          <div className='max-w-[420px] space-y-1'>
            <h1 className='text-2xl font-bold leading-tight text-gray-50'>Sua cápsula do tempo</h1>
        ...
        <div className='text-sm leading-relaxed text-gray-200'>
          Feito com 💜 no NLW da {' '}
          <a className='underline hover:text-gray-50' href="https://rocketseat.com.br" target='_blank' rel='noreferrer'>Rocketseat</a>
        </div>
      ...
      <div className="flex flex-col p-16 bg-[url(../assets/bg-stars.svg)] bg-cover">
        <div className="flex flex-1 items-center justify-center">
          <p className="text-center leading-relaxed w-[415px]">
